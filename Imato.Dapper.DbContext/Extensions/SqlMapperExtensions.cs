...
namespace Imato.Dapper.DbContext
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        /// <summary>
        /// Mapping: property name of T <-> column name </summary> <param name="type"></param> <returns></returns>
...
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        /// <summary>
        /// Inserts an entity into table "Ts" and returns identity id or number of inserted rows if
        /// inserting a list.
        /// </summary>
        ...
        /// <summary>
        /// Updates entity in table "Ts", checks if the entity is modified if the entity is tracked
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            for (var i = 0; i < nonIdProps.Count; i++)
            {
                ...
                adapter.AppendColumnNameEqualsValue(sb, ColumnNameCache(type, property.Name), property.Name);  //fix for issue #336
        ...
        public static void RegisterType(Type type)
        {
            SqlMapper.SetTypeMap(
                ...
                new CustomPropertyTypeMap(
                    ...
                    (t, columnName) =>
                    {
                        var p = t.GetProperties().FirstOrDefault(prop =>
                            prop.GetCustomAttributes(false)
                                .OfType<ColumnAttribute>()
                                .Any(attr => attr.Name == columnName)
                            || prop.Name.Equals(columnName, StringComparison.InvariantCultureIgnoreCase));
